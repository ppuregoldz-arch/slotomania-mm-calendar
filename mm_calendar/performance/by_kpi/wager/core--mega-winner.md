...
- **Variant ID:** `core--mega-winner`
- **Family:** `core`
- **Default Main KPI:** `wager`
- **Instances:** 2 rows across 2 dates (2026-06-09 to 2026-06-22)
...
|---|---:|---:|---:|---:|---:|---|---|
| Revenue | 2 | $630,377 | $610,049 | $+20,328 | +3.3% | correlation | low |
| Paying users | 2 | 29,906 | 29,906 | -0 | -0.0% | correlation | low |
...
- Concurrent promotion present on 2/2 instance rows.
- Segments observed: dpu, unknown.
