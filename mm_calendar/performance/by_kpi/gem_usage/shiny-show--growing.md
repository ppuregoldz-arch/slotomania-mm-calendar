...
- **Variant ID:** `shiny-show--growing`
- **Family:** `shiny-show`
- **Default Main KPI:** `gem_usage`
- **Instances:** 2 rows across 2 dates (2026-05-09 to 2026-06-14)
...
|---|---:|---:|---:|---:|---:|---|---|
| Revenue | 2 | $692,525 | $668,365 | $+24,160 | +3.6% | correlation | low |
| Paying users | 2 | 27,920 | 27,780 | +139 | +0.5% | correlation | low |
