...
- **Variant ID:** `buy-all--wild`
- **Family:** `buy-all`
- **Default Main KPI:** `revenue`
- **Instances:** 2 rows across 2 dates (2026-05-08 to 2026-07-08)
...
|---|---:|---:|---:|---:|---:|---|---|
| Revenue | 1 | $682,536 | $681,112 | $+1,424 | +0.2% | correlation | low |
| Paying users | 1 | 27,709 | 26,412 | +1,297 | +4.9% | correlation | low |
